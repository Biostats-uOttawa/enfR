...
![](images/author/augustin_circ.jpg){fig-align="center" width="100%"}
...
La première partie du livre sur l'utilisation de R a commencé comme un fork sur github à partir de l'excellent livre en anglais
...
Julien Martin. ({{< meta year >}}). Sur le chemin de l'enf-R. Un livre multilingue d'introduction à R. Version: {{< meta version >}} ({{< meta date >}}).
DOI: [{{< meta doi >}}](https://zenodo.org/doi/{{< meta doi >}})
...
![](images/cover/book_hex_fr.png){fig-align="center" width="50%"}
