...
knitr::include_graphics(path = "images/start/rstudio-fr.png")
```
...
knitr::include_graphics(path = "images/start/rconsole_eval-fr.png")
```
...
knitr::include_graphics(path = "images/start/new_script-fr.png")
```
...
knitr::include_graphics(path = "images/start/rstudio_new-fr.png")
```
...
knitr::include_graphics(path = "images/start/rstudio_run-fr.png")
```
...
digraph {
  ...
  data [label =  "donées", fillcolor="lightblue"]
  functions [label =  "fonctions", fillcolor="lightgreen"]
  outputs [label =  "sortie", fillcolor="orange"]
...
knitr::include_graphics(path = "images/start/new_proj-fr.png")
```
...
knitr::include_graphics(path = "images/start/new_proj1-fr.png")
```
...
knitr::include_graphics(path = "images/start/new_proj2-fr.png")
```
...
knitr::include_graphics(path = "images/start/new_proj3-fr.png")
```
...
knitr::include_graphics(path = "images/start/new_proj4-fr.png")
```
...
knitr::include_graphics(path = "images/start/new_proj5-fr.png")
```
...
knitr::include_graphics(path = "images/start/before_rcode-fr.png")
```
...
knitr::include_graphics(path = "images/start/styler-fr.png")
```
...
knitr::include_graphics(path = "images/start/after_rcode-fr.png")
```
