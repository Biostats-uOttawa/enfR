...
`ggplot2` :package: est basé sur le livre *Grammar of Graphics* (la grammaire de graphiques) de @wilkinson2005.
 (Vous trouverez un résumé intéressant du livre [ici][leland-summary]). 
...
Les six graphiques montrent la relation entre ces deux variables pour différents intervalles de taille de crinière 
...
Par exemple, le graphique en haut à gauche montre la relation entre le nombre d'anneaux sur la corne et le poids des licornes dont la crinière est la plus courte (environ 5 - 11 cm).
